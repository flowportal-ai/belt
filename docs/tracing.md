...
By default, tracing to console and cost tracking is enabled. To configure tracing, pass a TracingConfig object [`TracingConfig`][flow_portal.config.TracingConfig] when creating an agent.
