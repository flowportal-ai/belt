...
from flow_portal.evaluation.evaluation_runner import EvaluationRunner
...
def test_evaluation_runner_runs_all_cases(
    ...
    with (
        patch(
            "flow_portal.evaluation.evaluation_runner.CheckpointEvaluator"
        ) as mock_checkpoint_eval_cls,
        patch(
            "flow_portal.evaluation.evaluation_runner.HypothesisEvaluator"
        ) as mock_hypothesis_eval_cls,
        patch(
            "flow_portal.evaluation.evaluation_runner.QuestionAnsweringSquadEvaluator"
        ) as mock_qa_eval_cls,
        patch(
            "flow_portal.evaluation.evaluation_runner.save_evaluation_results"
        ) as mock_save_results,
        patch(
            "flow_portal.evaluation.evaluation_runner.TracingProcessor.create"
