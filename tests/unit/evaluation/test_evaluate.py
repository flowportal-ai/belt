...
def test_evaluate_runs_all_evaluators(
    ...
    with (
        patch(
            "flow_portal.evaluation.evaluate.CheckpointEvaluator"
        ) as mock_checkpoint_eval_cls,
        patch(
            "flow_portal.evaluation.evaluate.HypothesisEvaluator"
        ) as mock_hypothesis_eval_cls,
        patch(
            "flow_portal.evaluation.evaluate.QuestionAnsweringSquadEvaluator"
        ) as mock_qa_eval_cls,
        patch(
            "flow_portal.evaluation.evaluate.TracingProcessor.create"
