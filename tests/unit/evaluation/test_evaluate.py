...
from flow_portal.evaluation.schemas import (
    EvaluationResult,
)
...
def test_evaluate_runs_all_evaluators(
    ...
    with (
        patch(
            "flow_portal.evaluation.evaluate.evaluate_checkpoint",
            mock_checkpoint_evaluate,
        ),
        patch(
            "flow_portal.evaluation.evaluate.evaluate_hypothesis",
            mock_hypothesis_evaluate,
        ),
        patch("flow_portal.evaluation.evaluate.evaluate_qa_squad", mock_qa_evaluate),
        patch("flow_portal.evaluation.evaluate.TracingProcessor.create"),
    ):
        evaluate(
