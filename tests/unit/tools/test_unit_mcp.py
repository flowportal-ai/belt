...
from flow_portal.tools import get_mcp_server
...
@patch("flow_portal.tools.mcp.frameworks.smolagents.MCPClient")
...
def test_openai_mcpsse() -> None:
    ...
    with patch(
        "flow_portal.tools.mcp.frameworks.openai.OpenAIInternalMCPServerSse",
...
async def test_smolagents_mcp_sse() -> None:
    ...
    with patch(
        "flow_portal.tools.mcp.frameworks.smolagents.MCPClient"
...
async def test_google_mcp_sse() -> None:
    ...
    with (
        patch(
            "flow_portal.tools.mcp.frameworks.google.GoogleMCPToolset"
        ) as mock_toolset_class,
        patch(
            "flow_portal.tools.mcp.frameworks.google.GoogleSseServerParameters"
        ) as mock_sse_params,
    ):
        # Set up mock toolset
...
async def test_llamaindex_mcp_sse() -> None:
    ...
    with (
        patch(
            "flow_portal.tools.mcp.frameworks.llama_index.LlamaIndexMCPClient"
        ) as mock_client_class,
        patch(
            "flow_portal.tools.mcp.frameworks.llama_index.LlamaIndexMcpToolSpec"
...
async def test_agno_mcp_sse() -> None:
    ...
    with (
        patch(
            "flow_portal.tools.mcp.frameworks.agno.ClientSession"
        ) as mock_client_session,
        patch("flow_portal.tools.mcp.frameworks.agno.AgnoMCPTools") as mock_mcp_tools,
    ):
        # Set up mocks
        mock_transport = (AsyncMock(), AsyncMock())
