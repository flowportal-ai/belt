...
from flow_portal.tools.wrappers import (
    wrap_tool_langchain,
...
def test_wrap_tool_langchain():
    ...
    with patch("langchain_core.tools.tool", wrapper):
        wrap_tool_langchain("flow_portal.tools.search_web")
        wrapper.assert_called_with("flow_portal.tools.search_web")
...
def test_wrap_tool_llama_index():
    ...
    with patch.object(FunctionTool, "from_defaults", wrapper):
        wrap_tool_llama_index("flow_portal.tools.search_web")
        wrapper.assert_called_with("flow_portal.tools.search_web")
...
def test_wrap_tool_openai():
    ...
    with patch("agents.function_tool", wrapper):
        wrap_tool_openai("flow_portal.tools.search_web")
        wrapper.assert_called_with("flow_portal.tools.search_web")
...
def test_wrap_tool_smolagents():
    ...
    with patch("smolagents.tool", wrapper):
        wrap_tool_smolagents("flow_portal.tools.search_web")
        wrapper.assert_called_with("flow_portal.tools.search_web")
