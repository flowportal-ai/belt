...
def test_load_openai_agent_default():
    ...
    with (
        patch("flow_portal.agents.openai_agent.Agent", mock_agent),
...
def test_openai_agent_with_api_base_and_api_key_var():
    ...
    with (
        patch("flow_portal.agents.openai_agent.Agent", mock_agent),
        patch("flow_portal.agents.openai_agent.AsyncOpenAI", async_openai_mock),
        patch(
            "flow_portal.agents.openai_agent.OpenAIChatCompletionsModel",
...
def test_load_openai_agent_with_mcp_server():
    ...
    with (
        patch("flow_portal.agents.openai_agent.Agent", mock_agent),
        patch("agents.function_tool", mock_function_tool),
        patch("flow_portal.agents.openai_agent.import_and_wrap_tools") as mock_wrap_tools,
    ):
