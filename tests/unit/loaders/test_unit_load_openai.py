...
from flow_portal.loaders.openai import (
    load_openai_agent,
)
...
def test_load_openai_agent_default():
    ...
    with (
        patch("flow_portal.loaders.openai.Agent", mock_agent),
...
def test_run_openai_agent_with_api_base_and_api_key_var():
    ...
    with (
        patch("flow_portal.loaders.openai.Agent", mock_agent),
        patch("flow_portal.loaders.openai.AsyncOpenAI", async_openai_mock),
        patch(
            "flow_portal.loaders.openai.OpenAIChatCompletionsModel",
...
def test_load_openai_agent_with_mcp_server():
    ...
    with (
        patch("flow_portal.loaders.openai.Agent", mock_agent),
        patch("agents.function_tool", mock_function_tool),
        patch("flow_portal.loaders.openai.import_and_wrap_tools") as mock_wrap_tools,
    ):
