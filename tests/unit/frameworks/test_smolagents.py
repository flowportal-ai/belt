...
def test_load_smolagent_default() -> None:
    ...
    with (
        patch("flow_portal.frameworks.smolagents.DEFAULT_AGENT_TYPE", mock_agent),
        patch("flow_portal.frameworks.smolagents.DEFAULT_MODEL_TYPE", mock_model),
...
def test_load_smolagents_agent_missing() -> None:
    with patch("flow_portal.frameworks.smolagents.smolagents_available", False):
...
def test_run_smolagent_custom_args() -> None:
    ...
    with (
        patch("flow_portal.frameworks.smolagents.DEFAULT_AGENT_TYPE", mock_agent),
        patch("flow_portal.frameworks.smolagents.DEFAULT_MODEL_TYPE"),
