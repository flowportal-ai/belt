...
def test_load_openai_default() -> None:
    ...
    with (
        ...
        patch("flow_portal.frameworks.openai.LitellmModel", mock_litellm_model),
    ):
...
def test_openai_with_api_base() -> None:
    ...
    with (
        patch("flow_portal.frameworks.openai.Agent", mock_agent),
        patch(
            "flow_portal.frameworks.openai.LitellmModel",
            litllm_model_mock,
        ),
    ):
        AnyAgent.create(
...
def test_run_openai_with_custom_args() -> None:
    ...
    with (
        ...
        patch("flow_portal.frameworks.openai.LitellmModel"),
    ):
